        ...
        <div class="form-container">
            <div class="form">
                <form action="login.php" method="post">
                    <h1 align="center"><font color="black">Student Login</font></h1>
                    ...
                    <p class="data" style="text-align: center;">New Member? <a href="register.php" style="color:blue;text-decoration:none">Sign-Up</a></p>
                    <p class="psw" style="text-align: center;"><a href="forgot.php"style="color:blue;text-decoration:none">Forgot password?</a></p>
                </form>
            </div>
        </div>
