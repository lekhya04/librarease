...
if (isset($_GET['username'])) {
    ...
    $query = "SELECT * FROM returnrecords WHERE stu_id = '$stu_id' ORDER BY id DESC";
...
<header>
    ...
    <div class="container">
        ...
        <table>
            ...
            <tbody>
                ...
                while ($row = mysqli_fetch_assoc($result)) {
                    ...
                    echo '<td><a href="return.php?return_id=' . $row['id']  . '&username=' . $stu_id . '" class="return-link"><button class="return-button">Returned</button></a></td>';
                    echo '</tr>';
                }
                ?>
            </tbody>
        ...
        <div class="but">
            <a href="return_records.php" target="_self">
